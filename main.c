...
//    FILE *ofp;
//    char *mode = "w";
//    char outputFilename[] = "/Users/pingu/Desktop/count.txt";
//    char outputFilename1[] = "/Users/pingu/Desktop/label.txt";
//    
...
//    }
    ...
    printf("########################\n");
    printf("Round 16 key using Key Schedule\n\n");
    printkey(schedule[15]);
    printf("########################\n");
    printf("Hacked individual 6bit round keys\n\n");
...
//        delta_r(text1,schedule,key_hack,count,pointer,0x44444444);
...
//    ofp = fopen(outputFilename1,mode);
//    
//    if (ofp == NULL)
//    {
//        fprintf(stderr, "Can't open output file %s!\n",outputFilename);
...
//    display_count(count);
    getkey(key_hack,count,keyhack);
    printf("########################\n");
    printf("Round 16 key obtained combining the individual keys gra\n\n");
    printkey(keyhack);
    printf("########################\n");
